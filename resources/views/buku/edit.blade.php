...
<div class="container mt-5">
    ...
    <form method="post" action="{{ route('buku.update', $buku->id) }}" enctype="multipart/form-data">
        ...
        {{-- Kolom untuk input gambar sebagai cover --}}
        <div class="mb-3">
            <label for="gambar" class="form-label">Gambar</label>
            <input type="file" class="form-control @error('cover') is-invalid @enderror" id="cover" name="cover"
                value="{{ old('cover') }}" onchange="previewImage(event)">
            {{-- Tag img untuk menampilkan preview --}}
            <img id="imagePreview" src="{{ asset('storage/'.$buku->cover) }}" alt="Preview Cover"
                style=" max-width: 30vw; margin-top:10px;">


        </div>
        {{-- JS untuk membuat preview --}}
        <script>
                            ...
                            git diff <branch>: Compares your current branch with another branch.
                                ...
                                git show <commit-hash>: Displays detailed information about a specific commit.
                                    ...
                                    git remote add origin <repository-url>: Adds a remote repository URL.
                                        ...
                                        git push origin <branch-name>: Pushes commits from the local branch to the
                                            remote branch.
                                            git pull origin <branch-name>: Pulls the latest changes from the remote
                                                ...
                                                git tag <tag-name>: Creates a new tag.
                                                    git push origin <tag-name>: Pushes a tag to the remote repository.
                                                        ...
                                                        repository.
                                                        8. Undoing Changes
                                                        git reset <file>: Unstages a file (without affecting its
                                                            content).
                                                            git reset --hard <commit-hash>: Resets the current branch to
                                                                a specific commit, discarding all changes.
                                                                git revert <commit-hash>: Reverts the changes of a
                                                                    specific commit by creating a new commit.
                                                                    ...
                                                                    git rebase <branch-name>: Reapplies commits on top
                                                                        of another base branch.
                                                                        git cherry-pick <commit-hash>: Applies a
                                                                            specific commit from one branch into another
                                                                            branch.
                                                                            10. Inspection
                                                                            git blame <file>: Shows who made the changes
                                                                                to each line in a file.
                                                                                git bisect: Helps to find a commit that
                                                                                introduced a bug using binary search.
                                                                                git reflog: Shows a log of changes to
                                                                                the local repository (useful for
                                                                                recovering lost commits).
                                                                                11. Cleaning Up
                                                                                git clean -f: Removes untracked files
                                                                                from the working directory.
                                                                                git gc: Optimizes the local repository
                                                                                by cleaning up unnecessary files and
                                                                                compressing file history.
